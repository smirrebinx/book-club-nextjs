...
export function SuggestionTableRow({
  ...
  const getPlacementBadge = (placement: 1 | 2 | 3) => {
    switch (placement) {
      case 1:
        return <span className="text-xl mr-1" title="1:a plats">🥇</span>;
      case 2:
        return <span className="text-xl mr-1" title="2:a plats">🥈</span>;
      case 3:
        return <span className="text-xl mr-1" title="3:e plats">🥉</span>;
    }
  };
